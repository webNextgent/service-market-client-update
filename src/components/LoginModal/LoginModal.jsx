...
//     const [allCountries] = useState(COUNTRIES_DATA);
...
//                                             className={`w-full px-4 py-3 flex items-center justify-between hover:bg-gray-50 transition-colors ${selectedCountry?.iso2 === country.iso2 ? 'bg-orange-50' : ''
//                                                 }`}
//                                         >
