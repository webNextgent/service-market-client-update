                        ...
                        <div className="flex-1">
                            ...
                            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 md:gap-4">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <div className="flex items-center">
                                        <img
                                            ...
                                            alt="AED"
                                        />
                                        <span className="font-semibold text-base md:text-lg text-gray-900 mb-0.5">
                                ...
                                <div className="w-full md:w-auto mt-1 md:mt-0">
                                    <button className="min-w-[120px] border border-[#01788E] px-3 py-2 md:px-4 md:py-2.5 flex items-center justify-center gap-2 text-[#01788E] rounded-lg text-xs md:text-sm font-medium cursor-pointer">
